    ...
    <div class="relative">
        ...
        <div class="relative z-10 mt-32 pb-20 sm:mt-56 sm:pb-24 xl:pb-0">
            <div class="absolute inset-0 overflow-hidden">
                <!-- <svg viewBox="0 0 1097 1023" aria-hidden="true"
                    class="absolute top-[calc(50%-36rem)] left-[calc(50%-19rem)] w-[68.5625rem] transform-gpu blur-3xl">
                    <path fill="url(#a)" fill-opacity=".25"
                    ...
                    <defs>
                        <linearGradient id="a" x1="1097.04" x2="-173.036" y1=".267" y2="307.794"
            ...
            <div
                ...
                <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                    <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                        <div class="absolute inset-0 h-full w-full object-cover shadow-2xl pl-12 pt-6"
                            style="background: #091314; color: #b1cdc4; font-family: 'Cormorant Garamond', serif;">
                            <span class="opacity-30" style="font-size: 80px;">About</span>
                            <div class="flex flex-col justify-center opacity-40 leading-1" style="font-size: 120px;">
                                <span>M</span>
                                <span style="margin-top: -80px;">E</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:py-24 xl:px-16">
                    <figure class="relative isolate pt-6 sm:pt-12">
                        <svg viewBox="0 0 162 128" fill="none" aria-hidden="true"
                            class="absolute top-0 left-0 -z-10 h-32 opacity-10">
                            <path id="b56e9dab-6ccb-4d32-ad02-6b4bb5d9bbeb" style="fill: #091314;"
                        ...
                        <blockquote class="text-xl font-semibold leading-8 sm:text-2xl sm:leading-9" style="color: #091314; font-family: 'Cormorant Garamond', serif;">
