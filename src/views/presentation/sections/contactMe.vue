        ...
        <div class="bg-green_giorgia-50 lg:py-16 sm:py-24">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div
                    ...
                    <p class="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">Contattami via mail o
                        WhatsApp, sono sempre disponibile ad approfondire nuove idee e progetti!</p>

                    <div
                        class="flex flex-col lg:flex-row w-full items-center lg:justify-center space-y-16 lg:space-y-0 lg:space-x-16 pt-20">
                        <a :href="'whatsapp://send?phone=' + phoneNumberPlain + '&abid=' + phoneNumberPlain"
                            ref="phoneNumberButton"
                            class="group flex flex-col items-center justify-center w-52 h-52 backdrop-blur-xl border-2 border-purple_giorgia-400/10 bg-purple_giorgia-400/20 hover:bg-purple_giorgia-400/30 active:bg-purple_giorgia-400/40 rounded-full transition-colors ease-in-out duration-150 cursor-pointer">
                            <div class="mb-3">
                                <svg class="svg-image filled text-green_giorgia-300 w-8 h-8"
                            ...
                            <span
                                class="text-green_giorgia-100 group-hover:text-green_giorgia-50 transition-colors ease-in-out duration-150">{{
                                    phoneNumber }}</span>
                        </a>
                        <button type="button" @click="copyEmail" ref="emailButton"
                            class="group flex flex-col items-center justify-center w-72 h-72 backdrop-blur-xl border-2 border-purple_giorgia-400/10 bg-purple_giorgia-400/20 hover:bg-purple_giorgia-400/30 active:bg-purple_giorgia-400/40 rounded-full transition-colors ease-in-out duration-150 cursor-pointer">
                            <div class="mb-3">
                                <svg class="svg-image filled text-green_giorgia-300 w-8 h-8"
                    ...
                    <svg viewBox="0 0 1024 1024"
                        ...
                        <defs>
                            <radialGradient id="giorgia_circle_gradient" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
...
function copyOnDeviceClipboard(text: string) {
    return new Promise<void>((resolve, reject) => {
        if (typeof navigator !== "undefined" && typeof navigator.clipboard !== "undefined" && (navigator.permissions as any) !== "undefined") {
